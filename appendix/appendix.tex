...
\begin{figure}[htpb]
	...
	\caption{Predicted arms deals between the United States and other states 1950 to 2014 by presidential election proximity and partner democracy based on a Poisson regression model with only . Points mark the estimates and error bars summarize the 90\% credible interval.}
	\label{fig:nocont-deals-pred}
\end{figure}
