...
As I show in the appendix, 98\% of the posterior mass of the deals and swing state interaction is positive, so the preponderance of evidence supports the deals and contracts hypothesis.
...
To further illustrate what this means for defense contracting in practice, I plot the estimated changes in defense contracting from 2007 to 2008 in \autoref{fig:map-08-full}. 
To do this, I take the posterior draws of predicted defense contracting in 2007 and 2008 across all states. 
...
\begin{figure}[htpb]
	...
	\caption{Predicted changes in defense contracts during 2007/2008 presidential election, divided by electoral coalition status. Darker shading in the map indicates a larger increase in contracts. Estimates in millions of U.S. dollars.}
...
Some core Democratic states also received more contracts. 
