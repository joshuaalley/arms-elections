...
As noted above, aggregating country-year arms deals predictions into an annual measure that can apply to the model of contracts in U.S. states is inaccurate.%\footnote{A model predicting aggregate defense deals over time could work for this, but it would not show regime and alliance differences in arms deals.}
