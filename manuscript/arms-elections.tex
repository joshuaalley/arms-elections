...
\begin{abstract} 
Arms deals with autocracies help U.S. leaders increase defense contracting in swing states as elections approach. 
...
% puzzle
While 50 years separates these two arms deals, they suggest that domestic political competition in the United States encourages arms deals with autocracies. 
U.S. leaders make more arms deals with autocracies as elections approach in order to claim credit for the jobs associated with sales and increase defense contracting to in fact improve economic conditions.
Leaders then focus new defense contract awards on swing states, improving economic conditions in key electoral regions.
...
% arms exports logic
Autocracies make arms deals near U.S. elections because they have additional security motivation and necessary political flexibility. 
...
Finally, I explain how low political constraints and additional security motivation make autocracies willing and able to make arms deals around U.S. elections.
...
In the United States, leaders cannot easily manipulate macroeconomic policy. 
Federal Reserve independence limits political influence on monetary policy in the United States \citep{ClarkHallerberg2000}, so that cycle tool has less heft. 
...
For example, U.S. leaders often initiate trade disputes for industries in swing states as elections approach \citep{Conconietal2017}.\footnote{Else where, leaders also use labor agreements \citep{Ahlquist2010} and land reform \citep{Philips2020} to win support in key constituencies.} 
