...
\title{\textbf{Arms and Electoral Influence: How Arms Deals with Autocratic Allies Stabilize Defense Contracting in Swing States}}
\author{Joshua Alley \\
Assistant Professor \\
...
% seeking stability
When awarding defense contracts, leaders do not necessarily want political cycles, however. 
...
Firms and local business leaders could decry unstable contracting, and seek.
...
Moreover, when leaders want to award more contracts to swing state firms, the U.S. military may lack absorption capacity to incorporate outputs.
...
Arms deal cycles and defense contracting in swing states are the result of a large defense industry and many security commitments.
...
Electoral competition should also encourage leaders to smooth defense contracting over time. 
 

\begin{quote}
\textsc{Defense Contracts Hypothesis: Swing states will receive more prime defense contract awards and have lower variation in contract awards than other states.}
\end{quote}
...
\begin{quote}
\textsc{Deals and Contracts Hypothesis: Increasing arms deals increase the magnitude of the association between swing state status and contract awards.}
\end{quote}
