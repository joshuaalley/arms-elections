...
Arms deals with autocracies thus bolster leaders' efforts to retain power via political budget cycles \citep{Tufte1978, Mintz1988, DerouenHeo2000, Becker2021}. 
...
Electoral considerations therefore provide a new explanation of when, why and to whom the United States sells arms. 
...
This helps retain power for themselves or their party \citep{Tufte1978, Rogoff1987}. 
...
Leaders often retain discretion in allocating military spending. 
Defense spending often serves social welfare goals \citet{WhittenWilliams2011}.
...
Presidents face some constraints on disbursing contracts to swing states, however. 
...
Using arms deals and contracts to build electoral support likely works. 
...
Asking for additional appropriations to purchase arms is politically risky, because it might invite scrutiny. 
...
Autocratic security partners of the United States often rely on purchasing arms, because they have less sophisticated domestic defense industries \citep{Bitzinger2003} and weak or absent formal alliance ties \citep{Yarhi-Miloetal2016}. 
...
These states are thus more competitive than others in the core Democratic or Republican coalitions, and could determine the outcome of an election.\footnote{I provide a list of swing states in the appendix and map the consequences of a large increase in arms deals from 2007 to 2008.}
...
To examine the arms deals and defense contracts hypothesis, I calculate the positive posterior mass of the interaction between arms deals and swing states. Because the hypothesis expects a positive association, posterior posterior mass gives corresponding evidence in the interaction term.\footnote{For the marginal effect of swing status and outcome predictions, I again use 90\% credible intervals.}
...
I then show that autocrats who are especially dependent on the United States for security, are especially likely to make arms deals during elections.
...
Democratic allies gain security from closer peacetime defense cooperation. 
...
Most of the electoral cycle in U.S. arms deals with autocracies should occur with allied states. 
...
Alternative security arrangements, joint planning and constraints remove the means and motive for democracies to order more arms around presidential elections.
...
Aircraft and ship deals are particularly lucrative for swing state contractors. 
