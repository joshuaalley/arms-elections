...
% puzzle/question 
Substantial arms sales to autocracies and U.S. presidential elections often coincide because domestic political competition in the United States encourages arms deals with autocracies. 
...
Arms deals with autocracies thus bolster leaders' efforts to retain power by facilitating political budget cycles \citep{Tufte1978, Mintz1988, DerouenHeo2000, Becker2021}. 
...
% need an outline 
This paper begins by outlining the potential instruments of political business cycles in the United States, the importance of defense contracting, and how these factors encourage arms deals with autocracies. 
...
Electoral considerations impact policy \citep{Nordhaus1975}.
%\footnote{See \citet{Dubois2016} for a review of political budget cycle scholarship.} 
When leaders want to win office, they adjust policies to improve economic conditions and win votes. 
...
In the United States, leaders who want to maximize the electoral impact of defense contracts will focus on swing states.
...
Leaders face some constraints on disbursing contracts to swing states, however. 
...
Arms deals provide two electoral benefits, and leaders only need arms deals and confirmed orders to benefit.\footnote{Final transfers can and often do come years later. 
...
Other research finds that targeted spending can boost support for incumbents \citep{KrinerReeves2012}, and bringing in funds while claiming credit increases support for leaders \citep{Grimmeretal2012}. 
...
Highlighting the economic benefits of an arms deal also helps leaders secure Congressional approval. 
...
As a result, autocrats buy arms near elections because they have a consistent motive to buy U.S. arms and additional opportunity to do so. 
...
Autocrats have less opposition constraint and different security needs.
Even if other autocratic elites oppose additional outlays on U.S. arms, scrutiny of deals is less likely to occur or challenge an autocrats' power base. 
...
Autocratic security partners of the United States often rely on purchasing arms, because they have less sophisticated domestic defense industries \citep{Bitzinger2003} and weak or absent formal alliance ties. 
...
While arms transfers complement U.S. security commitments to democracies, sales substitute for peacetime cooperation and joint production in security guarantees to autocracies.
In some cases, arms transfers substitute entirely for formal security guarantees \citep{Yarhi-Miloetal2016}. 
Because arms are essential to U.S. security commitments, autocrats will make deals that increase their military capabilities.
...
Inasmuch as autocrats expect better arms sales near elections, they may buy fewer arms in other years, in order to use U.S. domestic politics to their advantage. 
...
This cooperative behavior and support for U.S. defense industrial jobs is likely to increase support for continued security cooperation in the United States, which bolsters autocrats' security.



% deliberate or not?
Election-adjacent arms purchases by autocrats likely reflect a mix of three factors that vary by deal.
...
My focus on the United States sets some scope conditions on the argument mechanics.
...
During Congressional elections, which happen two years from Presidential election, arms deals rise slightly. 
Autocratic states buy far more arms in Presidential election years, as predicted deals for a hypothetical state with minimum polyarchy rise from 1.5 to 2.25. 
...
The arms deal cycle diminishes as democracy increases, so states with a polyarchy score above the third quartile see no change in arms deals as elections approach.
...
But in election years, autocracies buy more U.S. arms. 
Thus, the political composition of U.S. arms deals depends on the presidential election cycle. 


In presidential and congressional election years, U.S. arms deals with autocracies rise.\footnote{I show in the appendix that these estimates are robust to looking at raw data, alternative estimates, and dropping potential outliers.}  
...
I then show that autocratic allies, who are especially dependent on the United States for security, are especially likely to make arms deals during elections.
...
This creates a triple interaction of alliance, regime type, and the election timing dummies. 
...
When allied polyarchy is at the minimum, predicted arms deals rise from 2.1 to 2.7 throughout the presidential election cycle.
Hypothesis tests of equality between allied arms deals at minimum democracy indicate a clear difference with a 90\% credible interval ranging from .54 to .94.
...
While aircraft deals with democratic allies are also common, they respond less to elections, so there is not a clear electoral cycle.  
...
Among autocracies, arms, ships and vehicle deals also increase in election years, though less clearly than aircraft. 
Perhaps due to limited domestic production, autocracies buy more electronics than democracies. 
Deals for arms and ships increase in presidential election years, and democracies strike more deals for both these defense goods.  
...
First, I focus on the United States as a most-likely case of elections leading to arms deals. 
