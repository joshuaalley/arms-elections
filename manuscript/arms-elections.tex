...
% puzzle/question 
The confluence of substantial arms deals with autocracies and U.S. presidential elections is not a coincidence.
Domestic political competition in the United States encourages arms deals with autocracies. 
As elections approach, U.S. leaders make more arms deals with autocracies in order to claim credit for defense industrial jobs and increase defense contracting to improve or maintain employment.
...
Last, my argument and findings help explain why the United States often sells arms to autocracies despite normative and geopolitical concerns. 
...
Also, if leaders want to award more contracts and expand or maintain defense production, the U.S. military may lack absorption capacity to incorporate outputs or not need older systems.
...
The Obama administration used employment to justify the \$60 billion sale to Saudi Arabia.
...
Highlighting the economic benefits of an arms deal helps leaders secure necessary Congressional approval. 
...
For this and other reasons, Congress has never successfully blocked an arms deals, and is more likely to attach conditions and monitoring when possible \citep{Thralletal2020}.\footnote{Congress blocked a 2019 arms sale to Saudi Arabia, but Trump overrode the joint resolution with a veto.}


% announcements and orders don't always line up  
Congressional approval is necessary for a foreign customer to place orders. 
As a result, there may be a gap between deal announcements and actual orders that stimulate contracts.
...
Democracies engage in joint production to secure their own domestic political benefits from defense jobs.
...
% explain why 
Limited alternatives make arms transfers pivotal to U.S. cooperation with autocracies.  
...
A second mechanism analysis demonstrates that autocratic allies in driving arms sale cycles, which illustrates the importance of autocrats who rely on the United States for security. 
...
Announcements without orders do not count, so all deals have Congressional approval and the partner has placed orders.
...
Transfers are less electorally salient. 
%Delivering arms to security partners is a necessary component of this cycle, but it is not electorally salient. 


The duration of deliveries makes more common arms transfer measures less helpful.
...
I scrutinize the security motivation by examining autocratic allies. 
...
These states have robust peacetime cooperation with the United States, and are more likely to benefit from signals of commitment besides arms.
...
I find that most of the the electoral rise in U.S. arms deals with autocracies includes deals for aircraft, ships and vehicles, all of which also increase swing state contracts. 
...
While these deals may send U.S. arms to risky destinations, electoral considerations dominate. 
