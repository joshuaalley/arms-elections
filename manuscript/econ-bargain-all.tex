...
\begin{tikzcd}[ampersand replacement=\&]
                                                                               \&             \&          \&  |[alias=Y]| \mbox{Trade Cycles}   \\
  \mbox{Budget Cycles} \arrow[to = Y, bend left = 15] \arrow[r]  \& \mbox{Defense Contracting} \arrow[r] \& \mbox{Arms Production} \arrow[r] \& \mbox{Arms to Allies} \arrow[u]  
\end{tikzcd}
}
