...
\centering
\begin{tikzcd}         
  \mbox{Budget Cycles} \arrow[to = Y, bend left = 15] \arrow[r]  & \mbox{Defense Contracting} \arrow[r] & \mbox{Arms Production} \arrow[r] & |[alias=Y]| \mbox{Trade \& Arms Export Cycles}   & 
\end{tikzcd}
}
