...
\begin{abstract} 
Political budget cycles of defense contracting in the United States increase international trade, especially arms exports to allies. 
...
A final analysis uses a Bayesian model to link defense contract awards around elections directly to arms exports and then connects arms exports to changes in trade.
The results suggest that security and economic ties help political elites in alliance patrons with avenues compete in elections. 
\end{abstract} 
...
While all economies with political budget cycles should pull in additional trade near elections, these effects are more pronounced in large economies. 


U.S. exports, imports and total trade from 1951 to 2019 exhibit cyclical behavior.
\autoref{fig:us-trade-cycles} presents the distribution of annual changes in logged exports, imports and overall trade as presidential elections approach.\footnote{This figure and later analyses examine changes in trade because levels are not stationary over time. Changes in the log of trade have a constant mean and variance, however.}
...
Federal Reserve independence means that the export cycles in \autoref{fig:us-trade-cycles} might require need additional explanation.\footnote{Both Lyndon Johnson and Donald Trump found major limits to their ability to browbeat Federal Reserve Chairs into changing monetary policy, to give two examples. 
...
Electoral cycles in defense contracting could explain export cycles.
...
\begin{tikzcd}[ampersand replacement=\&]
                                                   \& |[alias=Gr]| \mbox{Economic Growth}   \arrow[r]  \&  \mbox{Imports from Firms} \arrow[r]  \&  
                                                   |[alias=Y]| \begin{tabular}{c} \mbox{Trade Cycles} \\
                                                   \mbox{(U.S. Exports and Imports)}   \end{tabular} \\
\mbox{Electoral Budget Cycles} \arrow[bend left = 10, to = Gr] \arrow[r]  \& \mbox{Defense Contracting} \arrow[r] \& \mbox{Arms Production} \arrow[r] \& \mbox{Arms to Allies} \arrow[u]  
\end{tikzcd}
}
...
Imports also contribute to greater total trade around elections, but imports depend on firms and are less responsive to security cooperation.\footnote{The following analysis treats imports as a placebo.} 
...
This section presents Poisson regression estimates of annual arms deals, which are delivered at a later date. 
